 ...
 *
 * Derived from `@deepseek-ai/dsh-compaction-basic/types`.
...
/** Epoch compaction configuration with an optional exact-target policy table. */
...
export type EpochCompactionConfig = BasicCompactionConfig;
